...
Customer flows (signup, login, catalog, checkout from wallet) are covered there. Wallet loads from the card processor arrive as signed billing grants. Launch credits are documented in [`promos.md`](promos.md).
